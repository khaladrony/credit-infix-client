...
export class CorporateStructureService {
    ...
    constructor(
        ...
        this.API_FEATURE_NAME = '/financial-info/corporate-structure';
    }

    save(corporateStructureList: any, companyInfoId: any, submitType: string): Observable<any> {
        ...
        formData.append('corporateStructureList', JSON.stringify(corporateStructureList));
