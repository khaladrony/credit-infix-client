...
export class SummaryOpinionService {
  ...
  API_FEATURE_NAME: String;
    ...
    constructor(
        ...
        this.API_FEATURE_NAME = '/financial-info/summary-opinion';
    }

    save(summaryOpinionList: any, companyInfoId: any, submitType: string): Observable<any> {
        ...
        formData.append('summaryOpinionList', JSON.stringify(summaryOpinionList));
