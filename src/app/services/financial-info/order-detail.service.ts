...
export class OrderDetailService {
    ...
    constructor(
        ...
        this.API_FEATURE_NAME = '/financial-info/order-detail';
    }

    save(orderDetailList: any, companyInfoId: any, submitType: string): Observable<any> {
        ...
        formData.append('orderDetailList', JSON.stringify(orderDetailList));
